			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.Caoxin.model.Order o=(com.Caoxin.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.Caoxin.dao.UserDao userDao=new com.Caoxin.dao.UserDao();
						...
						<%
							...
							String paymentType=com.Caoxin.model.Payment.findByPaymentId(con,n);
							 %>
